...
registerWindow.add(emailRegTextField,passwordRegTextField,emailRegInputHint,passRegInputHint,emailRegInputView,passRegInputView, firstNameTextField,lastNameTextField, lastNameInputView, firstNameInputView);
